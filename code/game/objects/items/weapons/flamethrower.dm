...
/obj/item/flamethrower/proc/flame_turf(list/turflist)
	...
	if(power < REQUIRED_POWER_TO_FIRE_FLAMETHROWER)
		...
		playsound(src, 'sound/weapons/guns/flamethrower/flamethrower_empty.ogg', 50, TRUE, -3)
		return
	playsound(src, pick('sound/weapons/guns/flamethrower/flamethrower1.ogg','sound/weapons/guns/flamethrower/flamethrower2.ogg','sound/weapons/guns/flamethrower/flamethrower3.ogg' ), 50, TRUE, -3)
