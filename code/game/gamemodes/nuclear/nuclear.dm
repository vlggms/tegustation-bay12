...
/datum/game_mode/nuclear/declare_completion()
	...
	if(!disk_rescued &&  station_was_nuked && !syndies_didnt_escape)
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_MERCENARY_VICTORY_MAJOR)
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_TOTAL_ANNIHILATION)
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_CREW_VICTORY_MINOR)
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_CREW_VICTORY_MINOR_2)
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_CREW_VICTORY_SUPERMAJOR)
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_CREW_VICTORY_MAJOR)
		to_world("<FONT size = 3><B>Crew Major Victory</B></FONT>")
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_MERCENARY_VICTORY_MINOR)
		...
		SSticker.news_report = max(SSticker.news_report, SHIP_NUKEOPS_MERCENARY_VICTORY_MINOR_2)
		to_world("<FONT size = 3><B>Mercenary Minor Victory!</B></FONT>")
