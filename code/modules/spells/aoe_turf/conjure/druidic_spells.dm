...
/datum/spell/aoe_turf/conjure/summon/conjure_animation(var/atom/movable/overlay/animation, var/turf/target)
...
/datum/spell/aoe_turf/conjure/summon/bats/ImproveSpellPower()
	...
	newVars = list("maxHealth" = 20 + spell_levels[UPGRADE_POWER]*5, "health" = 20 + spell_levels[UPGRADE_POWER]*5, "melee_damage_lower" = 10 + spell_levels[UPGRADE_POWER], "melee_damage_upper" = 10 + spell_levels[UPGRADE_POWER]*2)
...
/datum/spell/aoe_turf/conjure/summon/bear
	...
	invocation_type = INVOKE_SHOUT
	level_max = list(UPGRADE_TOTAL = 4, UPGRADE_SPEED = 0, UPGRADE_POWER = 4)
