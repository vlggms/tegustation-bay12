/decl/cultural_info/location/human
	...
	capital = "Olympus"
	economic_power = 1.1
	description = "Mars, known by its nickname the Red Planet, is one of the most populous centres of Humanity. \
	...
	of Martian pride. The Martian people have not had an easy history. The people have seen great struggles \
...
/decl/cultural_info/location/human/earth
	...
	capital = "Geneva"
	economic_power = 1.4
	description = "Earth, home of humankind and current capital of SCG, has long been in a state of recovery \
	following centuries of pollution and exploitation. Earth is home to many of political intrugue and conflict, \
	housing most of Sol Central Government's officials and ministries. \
	Putting politics aside, Earth is the most safe place within Sol space, as expected of a capital world, \
	Allowing most of its population to experience peaceful life, free of crime and violence.\
	<br><br> \
	People from Earth are among the wealthier humans on average. \
	Owing to its status as the capital world, most citizens aspire to find success in politics or business."
