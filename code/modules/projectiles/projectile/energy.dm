...
/obj/item/projectile/energy/flash/flare/on_impact(var/atom/A)
	...
	set_light(1, 3, 8, 1, light_colour)
	..() //initial flash

	//residual illumination
	new /obj/effect/effect/smoke/illumination/flare(src.loc, rand(45 SECONDS, 60 SECONDS), range=8, power=1, color=light_colour) //same lighting power as flare
