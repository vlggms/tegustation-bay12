...
/datum/artifact_effect/proc/DoEffect(var/mob/user) // Targeted effect

/datum/artifact_effect/proc/DoEffectAura(var/atom/holder) // Repeating aura effect

/datum/artifact_effect/proc/DoEffectPulse(var/atom/holder) // Charging pulse effect, similar to aura
