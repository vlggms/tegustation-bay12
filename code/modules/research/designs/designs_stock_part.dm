...
/datum/design/item/stock_part/basic_capacitor
	...
	materials = list(MATERIAL_STEEL = 40, MATERIAL_GLASS = 40)
...
/datum/design/item/stock_part/super_capacitor
	...
	materials = list(MATERIAL_STEEL = 60, MATERIAL_GLASS = 60, MATERIAL_GOLD = 20)
...
/datum/design/item/stock_part/high_micro_laser
	...
	materials = list(MATERIAL_STEEL = 20, MATERIAL_GLASS = 30)
...
/datum/design/item/stock_part/ultra_micro_laser
	...
	materials = list(MATERIAL_STEEL = 30, MATERIAL_GLASS = 40, MATERIAL_URANIUM = 10)
...
/datum/design/item/stock_part/basic_sensor
	id = "basic_sensor"
	req_tech = list(TECH_MAGNET = 1)
	materials = list(MATERIAL_STEEL = 40, MATERIAL_GLASS = 20)
...
/datum/design/item/stock_part/adv_sensor
	id = "adv_sensor"
	req_tech = list(TECH_MAGNET = 3)
	materials = list(MATERIAL_STEEL = 60, MATERIAL_GLASS = 30)
...
/datum/design/item/stock_part/phasic_sensor
	...
	materials = list(MATERIAL_STEEL = 70, MATERIAL_GLASS = 40, MATERIAL_SILVER = 10)
