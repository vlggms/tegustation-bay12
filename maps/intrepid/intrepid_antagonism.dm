...
/datum/antagonist/ert
	...
	leader_welcome_text = "As leader of the Emergency Response Team, you are part of the Terran Government Fleet, and are there with the intention of restoring normal operation to the vessel or the safe evacuation of crew and passengers. You should, to this effect, aid the Commanding Officer or ranking officer aboard in their endeavours to achieve this."
...
/datum/antagonist/ert/equip(var/mob/living/carbon/human/player)
	...
	if(player.mind == leader)
		...
		sic = player.mind
		player.char_rank = mil_branches.get_rank("Fleet", "Master Chief Petty Officer")
	else if(prob(50))
	...
	var/decl/hierarchy/outfit/ert_outfit = outfit_by_type((player.mind == leader) ? /decl/hierarchy/outfit/job/intrepid/ert/leader : /decl/hierarchy/outfit/job/intrepid/ert)
