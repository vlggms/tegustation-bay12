 ...
 * Service
 */
/decl/closet_appearance/secure_closet/intrepid/hydroponics
	extra_decals = list(
...
/obj/structure/closet/chefcloset_intrepid
	name = "chef's closet"
	desc = "It's a storage unit for foodservice equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/black

/obj/structure/closet/chefcloset_intrepid/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_intrepid //done so that it has no access reqs
	name = "hydroponics locker"
	req_access = list()
	closet_appearance = /decl/closet_appearance/secure_closet/intrepid/hydroponics

/obj/structure/closet/secure_closet/hydroponics_intrepid/WillContain()
	return list(
...
/obj/structure/closet/jcloset_intrepid
	name = "custodial closet"
	desc = "It's a storage unit for janitorial equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/mixed

/obj/structure/closet/jcloset_intrepid/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/bar_intrepid
	name = "bar locker"
	desc = "It's a storage unit for bar equipment."
	req_access = list(access_bar)

/obj/structure/closet/secure_closet/bar_intrepid/WillContain()
	return list(
