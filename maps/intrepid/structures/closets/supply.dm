 ...
 * Supply
 */
/decl/closet_appearance/secure_closet/intrepid/cargo
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_BEASTY_BROWN,
		"cargo_upper" = COLOR_BEASTY_BROWN
	)

/decl/closet_appearance/secure_closet/intrepid/cargo/worker
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/intrepid/cargo/deck_officer
	extra_decals = list(
...
/obj/structure/closet/secure_closet/decktech
	...
	closet_appearance = /decl/closet_appearance/secure_closet/intrepid/cargo/worker
...
/obj/structure/closet/secure_closet/deckofficer
	...
	closet_appearance = /decl/closet_appearance/secure_closet/intrepid/cargo/deck_officer
...
/obj/structure/closet/secure_closet/deckofficer/WillContain()
	return list(
		...
		/obj/item/clothing/suit/armor/pcarrier/light/terra,
...
/obj/structure/closet/secure_closet/prospector
	...
	closet_appearance = /decl/closet_appearance/secure_closet/intrepid/cargo
