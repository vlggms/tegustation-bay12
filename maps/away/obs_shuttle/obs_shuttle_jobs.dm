/datum/job/submap/obs
	title = "OBS Member"
	total_positions = 3
	outfit_type = /decl/hierarchy/outfit/job/obs
...
/datum/job/submap/obs/pilot
	...
	scientist."
	outfit_type = /decl/hierarchy/outfit/job/obs/pilot
...
/datum/job/submap/obs/scientist
	...
	outfit_type = /decl/hierarchy/outfit/job/obs/scientist
